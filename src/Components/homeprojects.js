            ...
            <Card.Body>
              ...
              <div className="d-flex justify-content-center">
                <LinkContainer to={"/projects"}>
                  <button className=" px-5 py-3 my-4 btn btn-primary" href="#">
                    See my projects
                  </button>
                </LinkContainer>
              </div>
        ...
        <Col md={4}>
          <Card className="mb-5">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Personal logo design for a friend focussed on high class and
                letter design.
              </Card.Text>
              <Card.Subtitle className="mb-2 text-muted">
              ...
              <div className="d-flex justify-content-center">
                <LinkContainer to={"/projects"}>
                  <button className="my-4 px-5 py-3 btn btn-primary" href="#">
                    See my projects
                  </button>
                </LinkContainer>
              </div>
        ...
        <Col md={4}>
          <Card className="mb-5">
            ...
            <Card.Body>
              ...
              <Card.Text>
                Created a program where you can choose a game and register
